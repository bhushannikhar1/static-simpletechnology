...
export default function Problems() {
  const essayList = [
    { 
      ...
      link: "how-org-should-approach-cloud-migration", 
      description: "Cloud migration is often presented as an inevitable step in digital transformation. Cloud adoption should be a strategic decision driven by business value, technical feasibility, operational efficiency, and long-term sustainability.",
      tags: ["Cloud Migration", "Strategy", "Digital Transformation", "Infrastructure"]
    },
  ];
        ...
        <section className="border-b border-border bg-muted/30 py-16 md:py-24">
          <div className="mx-auto max-w-4xl px-6 lg:px-8">
            ...
            <p className="mt-6 text-xl leading-8 text-muted-foreground max-w-2xl">
              Cloud migration is often presented as an inevitable step in digital transformation. Cloud adoption should be a strategic decision driven by business value, technical feasibility, operational efficiency, and long-term sustainability.
            </p>
          </div>
        </section>
          ...
          <div className="mx-auto max-w-4xl px-6 lg:px-8">
            ...
            <div className="mb-10">
              <div className="relative rounded-2xl shadow-sm">
                ...
                <input
                  ...
                  placeholder="Search by title, description, or tags using commas (e.g. migration, strategy)..."
            ...
            {filteredEssays.length === 0 ? (
              <div className="rounded-2xl border border-dashed border-border p-12 text-center my-6">
                <svg className="mx-auto h-12 w-12 text-muted-foreground/60" xmlns="http://w3.org" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v3.75m9-.75a9 9 0 11-18 0 9 9 0 0118 0zm-9 3.75h.008v.008H12v-.008z" />
                </svg>
                <h3 className="mt-4 text-sm font-semibold text-foreground">No essays found</h3>
                <p className="mt-1 text-sm text-muted-foreground">Your search criteria didn't match any articles. Try different keywords.</p>
              </div>
            ) : (
                        ...
                        {item.tags && (
                          <div className="flex flex-wrap gap-2 mb-2">
                            {item.tags.map((tag, tagIdx) => (
                              <span key={tagIdx} className="inline-flex items-center rounded-md bg-muted px-2 py-1 text-xs font-medium text-muted-foreground ring-1 ring-inset ring-border">
                                {tag}
                              </span>
                            ))}
                          </div>
