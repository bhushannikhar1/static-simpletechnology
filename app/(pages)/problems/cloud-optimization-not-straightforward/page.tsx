...
export default function Problems() {
  const essayList = [
    { 
      ...
      link: "why-cloud-pricing-behaves-differently-than-traditional-infrastructure-pricing", 
      description: "An analysis of variable cost models, complex metering units, and why forklift migrations often break traditional corporate CapEx forecasting.",
        ...
        <section className="border-b border-border bg-muted/30 py-16 md:py-24">
          <div className="mx-auto max-w-4xl px-6 lg:px-8">
            ...
            <p className="mt-6 text-xl leading-8 text-muted-foreground max-w-2xl">
              Why reducing cloud costs requires more than identifying unused resources.
            </p>
          </div>
        </section>
            ...
            <div className="mb-10">
              <div className="relative rounded-2xl shadow-sm">
                ...
                <input
                  ...
                  placeholder="Search by title, description, or tags using commas (e.g. finops, optimization)..."
