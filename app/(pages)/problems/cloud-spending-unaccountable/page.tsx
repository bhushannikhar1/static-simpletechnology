...
export default function Problems() {
  const essayList = [
    { 
      ...
      link: "cloud-is-not-expensive-unaccountable", 
      description: "Why most businesses misunderstand cloud spending—and why that will define the next generation of leaders.",
        ...
        <section className="border-b border-border bg-muted/30 py-16 md:py-24">
          <div className="mx-auto max-w-4xl px-6 lg:px-8">
            ...
            <p className="mt-6 text-xl leading-8 text-muted-foreground max-w-2xl">
              Cloud spending increases without clear ownership of its business impact. Engineering teams make cost-driving decisions without financial accountability, while finance teams track cost without understanding its technical drivers. This disconnect leads to uncontrolled and unexplained cloud cost growth.
            </p>
          </div>
        </section>
            ...
            <div className="mb-10">
              <div className="relative rounded-2xl shadow-sm">
                ...
                <input
                  ...
                  placeholder="Search by title, description, or tags using commas (e.g. finops, finance)..."
