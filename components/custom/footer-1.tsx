...
export default function FooterSection() {
    return (
        <footer
            className="bg-background border-b py-8 sm:py-20">
            <div className="mx-auto max-w-5xl px-6">
                <div className="grid gap-12 md:grid-cols-5">
                    <div className="space-y-6 md:col-span-2">
                        ...
                        <span className="text-muted-foreground text-sm">© {new Date().getFullYear()} SimpleTechnology, All rights reserved </span>
                    </div>
